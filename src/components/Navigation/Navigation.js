  ...
  return (
    <div
      className={`navigation ${
        props.isOpen && props.screenWidth < 769 ? "navigation_opened" : ""
      }`}
    >
      ...
      {props.screenWidth < 769 && (
        <Link to="/" className="link link_place_side-menu-opened ">
          Главная
        </Link>
      )}
      <Link
        ...
        className={`link  ${
          props.screenWidth < 769
            ? "link_place_side-menu-opened"
            : "link_place_navigation"
        }`}
        onClick={props.menuHandler}
      >
        {"Фильмы"}
