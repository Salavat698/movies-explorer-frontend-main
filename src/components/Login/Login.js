    ...
    <div className="login">
      <div className="form__container">
        ...
        >
          ...
          <Field name="email" className="form__input" type="email">
            {({ onChange, ...props }) => {
              return (
                <input
                  disabled={props.submitting}
                  className={`${props.className} ${
                    errorStatusHandler(props) && "form__input_type_error"
                  }`}
            ...
            {(props) => {
              return (
                <span
                  {...props}
                  className={`${props.className} ${
                    !emailError && "form__error-span_type_hidden"
                  }`}
                >
          ...
          <Field name="password" className="form__input" type="password">
            {({ onChange, ...props }) => {
              return (
                <input
                  {...props}
            ...
            {(props) => {
              return (
                <span
                  {...props}
                  className={`${props.className} ${
                    !passwordError && "form__error-span_type_hidden"
                  }`}
                >
                  {errorMessageHandler(props)}
                </span>
          ...
          <SubmitButton
            className="form__button from__button_place_login"
            type="submit"
          >
            {({ disabled, ...props }) => {
              return (
                <button
                  {...props}
                  className={`${props.className} ${
                    disabled && "form__button_type_disabled"
                  }`}
                  disabled={isDisabled}
                >
                  {"Войти"}
        ...
        <p className="from__status-ask">
          Еще не зарегистрированы?
          {
            <Link
              to="/signup"
              className="link link_place_form link_place_form-login"
            >
              {" "}
              Регистрация
            </Link>
